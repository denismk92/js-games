////things to improve
//1. the bounce for loop should be a method
//2. look through code and replace duplicates with methods
...
window.addEventListener("load", function () {
  ...
  class SoundController {
    constructor(){
      ...
      this.backgroundMusic = new Audio('assets/MOP.mp3')
    }
    powerUp(){
  ...
  class Player {
    ...
    update(deltaTime) {
      ...
      if (this.projectiles.length > 0){
        this.game.sound.loopBackgroundMusic()
      }
    }
    draw(context) {
      if (this.game.debug)
